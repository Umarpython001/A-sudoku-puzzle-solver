...
How to Fix It (The "Better Loop Structure")

To implement backtracking, you need to think recursively. This means your function should call itself.

Here's the high-level logic we need to implement:

    Find an empty cell. This is what your find_zero_indexes() function does, so you're already doing this. But a better way would be to just find the first empty cell you encounter.
...
I want you to try to rewrite your main function, recursive_function(), to follow this new logic.

Don't worry about keeping all your old functions, like find_zero_indexes(). You can just start by finding the first zero you encounter.

Think about these questions:

    How will your function know when it's done?

    How will it know when a path has failed and it needs to "backtrack"?

    How will it "undo" a move?

Let's start there. Try to write a new recursive_solver() function that follows the recursive backtracking pattern we just discussed. Take your time, think it through, and don't hesitate to ask for help with the small details.
~
"""
